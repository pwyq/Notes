...
\begin{figure}[h!]
    \centering
     \includegraphics[width=0.7\textwidth]{td_lambda2.png}
...
\begin{figure}[h!]
    \centering
     \includegraphics[width=0.8\textwidth]{truncated_td.png}
...
\begin{figure}[h!]
    \centering
     \includegraphics[width=0.8\textwidth]{sarsa_lambda_backup.png}
